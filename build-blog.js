...
<head>
    ...
    <title>${escapeHtml(post.title)} | CharacterAIBots Blog</title>
...
<body>
    <header>
        <nav>
            <div class="logo"><a href="/" style="color: white; text-decoration: none;" title="CharacterAIBots Home">🤖 CharacterAIBots</a></div>
            <ul class="nav-links">
                <li><a href="/">Home</a></li>
...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>AI Roleplay Blog — Tips, Guides & Character Reviews | CharacterAIBots</title>
    ...
    <meta property="og:title" content="AI Roleplay Blog | CharacterAIBots">
