  ...
  return (
    <>
      <head>
        ...
        <link rel="canonical" href="https://www.characteraibots.com/guide" />
      </head>
            ...
            <div className="guide-section">
              ...
              <div className="character-types">
                <div className="type-card">
                  ...
                  <Link href="/category/yandere" className="type-link">Browse Yandere Characters →</Link>
                </div>

                <div className="type-card">
                  <h3>💢 Tsundere</h3>
                  <p>Characters with a tough exterior but a soft, caring interior. Initially cold but warm up over time.</p>
                  <Link href="/category/tsundere" className="type-link">Browse Tsundere Characters →</Link>
                </div>

                <div className="type-card">
                  <h3>❄️ Kuudere</h3>
                  <p>Cool, calm, and emotionless characters who rarely show their feelings openly.</p>
                  <Link href="/category/kuudere" className="type-link">Browse Kuudere Characters →</Link>
                </div>

                <div className="type-card">
                  <h3>🌸 Dandere</h3>
                  <p>Shy and quiet characters who are reserved around strangers but open up to those they trust.</p>
                  <Link href="/category/dandere" className="type-link">Browse Dandere Characters →</Link>
                </div>

                <div className="type-card">
                  <h3>🧛 Vampire</h3>
                  <p>Immortal and mysterious vampire characters perfect for dark fantasy roleplay scenarios.</p>
                  <Link href="/category/vampire" className="type-link">Browse Vampire Characters →</Link>
                </div>

                <div className="type-card">
                  <h3>✨ Fantasy</h3>
                  <p>Magical and fantastical characters from enchanted worlds with supernatural abilities.</p>
                  <Link href="/category/fantasy" className="type-link">Browse Fantasy Characters →</Link>
                </div>
              </div>
            </div>
